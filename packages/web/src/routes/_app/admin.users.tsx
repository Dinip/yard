  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-3">
        {/* Centred, with `leading-none` on both — see the note on the devices
            list for why the line boxes have to be stripped first. */}
        <div className="flex items-center gap-3">
          <h1 className="font-semibold text-2xl leading-none">Users</h1>
